...
#pragma endregion
		...
		//Boss_Wanda
		{
			...
			std::shared_ptr<Texture> wanda_die = Resources::Load<Texture>(L"wanda_die", L"Boss\\BossWanda_Die.png"); //씀
			...
			BossWanda_Animator->Create(L"wanda_chain", wanda_chain, Vector2(0.0f, 0.0f), Vector2(285.0f, 98.0f), Vector2(0.07f, -0.03f), 5, 2, 10, 0.11f , 3); //씀
			BossWanda_Animator->Create(L"wanda_chain2", wanda_chain, Vector2(0.0f, 196.0f), Vector2(285.0f, 98.0f), Vector2(0.07f, -0.03f), 5, 3, 5, 0.11f , 3); //씀
			BossWanda_Animator->Create(L"wanda_chain3", wanda_chain, Vector2(0.0f, 294.0f), Vector2(285.0f, 98.0f), Vector2(0.07f, -0.03f), 5, 5, 5, 0.11f , 3); //씀
			BossWanda_Animator->Create(L"wanda_chain4", wanda_chain, Vector2(0.0f, 392.0f), Vector2(285.0f, 98.0f), Vector2(0.07f, -0.03f), 5, 5, 5, 0.11f , 3); //씀
			...
			BossWanda_Animator->Create(L"wanda_die", wanda_die, Vector2(0.0f, 0.0f), Vector2(99.0f, 119.0f), Vector2(0.0f, -0.03f), 7, 6, 42, 0.10f); //씀
